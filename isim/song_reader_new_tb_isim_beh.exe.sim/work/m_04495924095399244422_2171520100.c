...
#endif
static const char *ng0 = "/afs/ir.stanford.edu/class/ee108/groups/8/final_project/song_reader_new.v";
...
LAB50:    memcpy(t7, t41, 8);

LAB51:    t42 = (t0 + 4648);
    xsi_vlogvar_assign_value(t42, t7, 0, 0, 5);
...
LAB80:    memcpy(t7, t42, 8);

LAB81:    t43 = (t0 + 4648);
    xsi_vlogvar_assign_value(t43, t7, 0, 0, 5);
    goto LAB19;
...
LAB28:    xsi_vlog_unsigned_bit_combine(t7, 5, t21, 5, t26, 5);
    goto LAB32;
...
LAB47:    xsi_vlog_unsigned_bit_combine(t7, 5, t27, 5, t41, 5);
    goto LAB51;

LAB49:    memcpy(t7, t27, 8);
    goto LAB51;

LAB52:    *((unsigned int *)t7) = 1;
    goto LAB55;

LAB57:    t20 = *((unsigned int *)t7);
    t22 = *((unsigned int *)t10);
...
LAB77:    xsi_vlog_unsigned_bit_combine(t7, 5, t41, 5, t42, 5);
    goto LAB81;

LAB79:    memcpy(t7, t41, 8);
    goto LAB81;
...
LAB12:    t33 = (t0 + 3448U);
    ...
    t33 = ((char*)((ng2)));
    memset(t35, 0, 8);
    xsi_vlog_unsigned_add(t35, 5, t34, 5, t33, 5);
    goto LAB13;
...
extern void work_m_04495924095399244422_2171520100_init()
{
	static char *pe[] = {(void *)Cont_28_0,(void *)Cont_31_1,(void *)Always_78_2,(void *)Cont_106_3,(void *)implSig1_execute,(void *)implSig2_execute,(void *)implSig3_execute,(void *)implSig4_execute};
	xsi_register_didat("work_m_04495924095399244422_2171520100", "isim/song_reader_new_tb_isim_beh.exe.sim/work/m_04495924095399244422_2171520100.didat");
